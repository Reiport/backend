...
insert into Request (company_name, truck_availability, container_availability, cargo_weight, deadline, port_dest, postal_code_dest, street_dest, port_ori, street_ori, delivery_price, container_license, container_license_second, license, client, invoice, postal_code_ori) values ('Só Milho', false, false, 6864424, '1/3/2025', '32138', '4200-014', 'Rieder', '30', 'Clyde Gallagher', 188645.72, 'J2-23-L7', 'I2-53-Y5', 'Z2-63-L1', 34, NULL, '4900-281');
insert into Request (company_name, truck_availability, container_availability, cargo_weight, deadline, port_dest, postal_code_dest, street_dest, port_ori, street_ori, delivery_price, container_license, container_license_second, license, client, invoice, postal_code_ori) values ('Apenas Trabalhamos', false, false, 8478072, '11/29/2025', '411', '3420-177', 'Morningstar', '1', 'Canary', 139717.17, 'Z2-33-U5', 'K2-83-L5', 'A2-83-J1', 36, 1, '4940-027');
insert into Request (company_name, truck_availability, container_availability, cargo_weight, deadline, port_dest, postal_code_dest, street_dest, port_ori, street_ori, delivery_price, container_license, container_license_second, license, client, invoice, postal_code_ori) values ('Contabilidade a dar com Pau', false, true, 2318309, '8/13/2024', '95121', '4490-251', 'Stuart', '5', 'Fair Oaks', 194567.71, 'N2-43-H9', 'Y2-53-K9', 'T2-03-S1', 42, 2, '2610-181');
insert into Request (company_name, truck_availability, container_availability, cargo_weight, deadline, port_dest, postal_code_dest, street_dest, port_ori, street_ori, delivery_price, container_license, container_license_second, license, client, invoice, postal_code_ori) values ('Antonio Costa <3', false, false, 2875034, '2/7/2026', '52', '4705-480', 'Trailsway', '58', 'Continental', 124905.81, 'F2-63-Y0', 'I2-83-V8', 'E2-23-L1', 62, NULL, '4200-014');
insert into Request (company_name, truck_availability, container_availability, cargo_weight, deadline, port_dest, postal_code_dest, street_dest, port_ori, street_ori, delivery_price, container_license, container_license_second, license, client, invoice, postal_code_ori) values ('Dor de Costas Spa', false, false, 6280363, '8/10/2025', '79', '7150-123', 'Southridge', '10', 'Warrior', 66088.15, 'U2-03-I8', 'L2-73-R0', 'G2-73-O1', 72, NULL, '4705-480');
insert into Request (company_name, truck_availability, container_availability, cargo_weight, deadline, port_dest, postal_code_dest, street_dest, port_ori, street_ori, delivery_price, container_license, container_license_second, license, client, invoice, postal_code_ori) values ('Antonio Mendes LDA.', true, false, 6120764, '6/29/2024', '59', '4900-281', 'Kingsford', '22664', 'Straubel', 165150.55, 'B2-33-S2', 'Y2-53-K9', 'X2-43-M1', 89, NULL, '3420-177');
insert into Request (company_name, truck_availability, container_availability, cargo_weight, deadline, port_dest, postal_code_dest, street_dest, port_ori, street_ori, delivery_price, container_license, container_license_second, license, client, invoice, postal_code_ori) values ('Madeira Forte e Dura', false, true, 9207649, '6/20/2024', '305', '4475-045', 'Northwestern', '236', 'Messerschmidt', 152754.14, 'W2-43-Q4', 'R2-23-K2', 'S2-13-C1', 92, NULL, '4475-045');
insert into Request (company_name, truck_availability, container_availability, cargo_weight, deadline, port_dest, postal_code_dest, street_dest, port_ori, street_ori, delivery_price, container_license, container_license_second, license, client, invoice, postal_code_ori) values ('Com isto não se brinca', true, true, 5430160, '6/5/2025', '64148', '4490-251', 'Haas', '6921', 'Killdeer', 170719.99, 'R2-73-Z9', 'Y2-73-G7', 'B2-13-U1', 66, NULL, '3420-177');
insert into Request (company_name, truck_availability, container_availability, cargo_weight, deadline, port_dest, postal_code_dest, street_dest, port_ori, street_ori, delivery_price, container_license, container_license_second, license, client, invoice, postal_code_ori) values ('TAP', false, false, 3457818, '1/9/2026', '80', '4475-045', 'Buhler', '23527', 'Warbler', 88729.78, 'W2-43-Q4', 'B2-83-T4', 'S2-63-P1', 107, 3, '4940-027');
insert into Request (company_name, truck_availability, container_availability, cargo_weight, deadline, port_dest, postal_code_dest, street_dest, port_ori, street_ori, delivery_price, container_license, container_license_second, license, client, invoice, postal_code_ori) values ('SLB', false, false, 7276042, '3/14/2025', '396', '4200-014', 'Crownhardt', '670', 'Messerschmidt', 124479.68, 'D2-33-C8', 'W2-43-O5', 'V2-03-N1', 103, NULL, '1000-139');
insert into Request (company_name, truck_availability, container_availability, cargo_weight, deadline, port_dest, postal_code_dest, street_dest, port_ori, street_ori, delivery_price, container_license, container_license_second, license, client, invoice, postal_code_ori) values ('FCP', true, true, 1038671, '10/26/2024', '74', '3040-474', 'Village Green', '6', 'Ryan', 192723.18, 'H2-53-E8', 'W2-43-Q4', 'A2-03-D1', 97, NULL, '4900-281');
insert into Request (company_name, truck_availability, container_availability, cargo_weight, deadline, port_dest, postal_code_dest, street_dest, port_ori, street_ori, delivery_price, container_license, container_license_second, license, client, invoice, postal_code_ori) values ('SCP', true, false, 6330370, '10/3/2024', '38310', '2610-181', 'Hooker', '33399', 'Cottonwood', 188790.44, 'D2-33-C8', 'Y2-93-F7', 'W2-23-H1', 101, NULL, '4905-067');
insert into Request (company_name, truck_availability, container_availability, cargo_weight, deadline, port_dest, postal_code_dest, street_dest, port_ori, street_ori, delivery_price, container_license, container_license_second, license, client, invoice, postal_code_ori) values ('Banco Investe Aqui', true, false, 1843130, '1/30/2026', '0', '3040-474', 'Ridge Oak', '38', 'Hauk', 121160.77, 'Y2-43-U9', 'R2-73-Z9', 'P2-83-N1', 106, NULL, '4475-045');
insert into Request (company_name, truck_availability, container_availability, cargo_weight, deadline, port_dest, postal_code_dest, street_dest, port_ori, street_ori, delivery_price, container_license, container_license_second, license, client, invoice, postal_code_ori) values ('Só madeira', false, true, 7730196, '8/19/2024', '2', '4900-281', 'Manitowish', '2790', 'Victoria', 90704.04, 'R2-23-R9', 'W2-03-Q2', 'B2-33-L1', 88, NULL, '4705-480');
insert into Request (company_name, truck_availability, container_availability, cargo_weight, deadline, port_dest, postal_code_dest, street_dest, port_ori, street_ori, delivery_price, container_license, container_license_second, license, client, invoice, postal_code_ori) values ('AgruCultura', true, false, 7688895, '5/18/2025', '1', '2205-025', 'Bellgrove', '406', 'Pond', 85234.12, 'I2-33-M5', 'I2-93-J7', 'S2-83-P1', 95, NULL, '4900-281');
insert into Request (company_name, truck_availability, container_availability, cargo_weight, deadline, port_dest, postal_code_dest, street_dest, port_ori, street_ori, delivery_price, container_license, container_license_second, license, client, invoice, postal_code_ori) values ('Comerciante de Latícinios', true, true, 8639081, '11/10/2024', '5117', '3360-032', 'Trailsway', '1744', 'Hintze', 182129.05, 'Q2-53-O3', 'Z2-03-L1', 'P2-03-K1', 83, 4, '4900-281');
insert into Request (company_name, truck_availability, container_availability, cargo_weight, deadline, port_dest, postal_code_dest, street_dest, port_ori, street_ori, delivery_price, container_license, container_license_second, license, client, invoice, postal_code_ori) values ('EcoDesaprove', false, false, 9554025, '10/14/2025', '071', '1000-139', 'Coleman', '9', 'Porter', 167884.88, 'I2-83-V8', 'A2-13-L3', 'O2-73-J1', 76, NULL, '4475-045');
insert into Request (company_name, truck_availability, container_availability, cargo_weight, deadline, port_dest, postal_code_dest, street_dest, port_ori, street_ori, delivery_price, container_license, container_license_second, license, client, invoice, postal_code_ori) values ('Ana Steeps Viagens', false, true, 9362522, '7/7/2025', '9528', '1000-139', 'Carey', '2', 'Fremont', 96364.42, 'P2-73-P3', 'N2-33-Z8', 'O2-73-J1', 94, NULL, '3420-177');
insert into Request (company_name, truck_availability, container_availability, cargo_weight, deadline, port_dest, postal_code_dest, street_dest, port_ori, street_ori, delivery_price, container_license, container_license_second, license, client, invoice, postal_code_ori) values ('Além do Mar', true, false, 9515452, '8/19/2025', '68219', '2645-539', 'Melrose', '94', 'Erie', 23687.24, 'N2-43-H9', 'N2-23-N9', 'S2-03-Z1', 57, NULL, '4475-045');
insert into Request (company_name, truck_availability, container_availability, cargo_weight, deadline, port_dest, postal_code_dest, street_dest, port_ori, street_ori, delivery_price, container_license, container_license_second, license, client, invoice, postal_code_ori) values ('Bar', true, true, 9016718, '4/7/2024', '82511', '4490-666', 'Homewood', '601', 'Montana', 109557.63, 'A2-13-L3', 'I2-93-J7', 'H2-53-E1', 74, NULL, '4905-067');
